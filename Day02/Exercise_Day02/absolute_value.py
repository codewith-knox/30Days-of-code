...
if number < 0:                      #logic : if number is negative
    print("The absolute value of this number is",-1*number)   #method : make negative number positive by giving 1 extra negative
else:
